...
class AddResumeScreen extends StatefulWidget {
  ...
  const AddResumeScreen({super.key, required this.isUpdate});
                ...
                child: Obx(() {
                  return Column(
                    ...
                    children: [
                                  ...
                                  child: ClipOval(
                                    child: Image(
                                      image: addResumeController.thumbnailNetworkImagePath.isNotEmpty
                                          ? NetworkImage(addResumeController.thumbnailImagePath.value)
                                          : FileImage(
                      ...
                      verticalSpace(10),
                      Container(
                        decoration: BoxDecoration(borderRadius: BorderRadius.circular(12), border: Border.all(color: AppColor.cBorder)),
                            ...
                            Row(
                              children: [
                                ...
                                Expanded(
                                  ...
                                  hintText: "Duration",
                                  validator: (v) {
                                    return Validator.validateName(v, "Duration");
                                  },
                                )),
                              ],
                            ),
